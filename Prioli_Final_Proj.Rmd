...
To test for a difference in infant mortality rate by human development category, Analysis #6 employed the permutation F-test and ANOVA as the nonparametric and parametric tests respectively.  Both tests assume samples are independent and identically distributed, and ANOVA additionally assumes a normal distribution.  The permutation F-test was performed using `jmuOutlier::perm.f.test()` whereas `aov()` was used for ANOVA testing.
...
analysis5_nonpara <- wilcox.test(alldata$genderequality_index, (alldata$SPI / 100),
