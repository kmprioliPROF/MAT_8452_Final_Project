...
For each variable except `country`, descriptive statistics were run and a sensible visualization was generated, following which a correlation matrix was produced to examine pairwise relationships between the variables.
...
Per Fig. 4, the World Happiness Score appears roughly normally distributed, having mean and median close in value, with reasonably small standard deviation.
