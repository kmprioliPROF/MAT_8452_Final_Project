...
The sign test is appropriate for this data; however, due to the clear nonnormality of the `HDIindex` data, the parametric test is inappropriate because the assumption of normality is violated.  Thus the sign test results were retained.


### *Analysis #2*

```{r analysis2, include = FALSE, echo = TRUE}
...
```{r analysis3, include = FALSE, echo = TRUE}
...
```{r analysis5, include = FALSE, echo = TRUE}
...
```{r analysis6, include = FALSE, echo = TRUE}
