...
```{r analysis1, include = FALSE, echo = TRUE}
analysis1_nonpara <- SIGN.test(x = alldata$HDIindex, md = mean(alldata$HDIindex), alternative = "two-sided")
```
