...
Based on the data exploration results, several formal hypotheses were generated about the data, and sensible nonparametric tests and their parametric equivalents were performed to assess these hypotheses.  Results of these parallel tests were compared in the context of the data and assumptions needed. 

### *Hypotheses*

Data exploration led to six hypotheses, as presented in Table 2.

**Table 2.  Hypotheses of Interest**

```{r generate_table2, echo = FALSE, eval = TRUE, message = FALSE, warning = FALSE}
tbl2_test <- c(1:6)
tbl2_null <- c("The sample median is equal to its mean",
               "Social progress and human development are not associated",
               "There is no relationship between log(GDP) and infant mortality",
               "Happiness is normally distributed",
               "Gender equality and adjusted social progress index have the same spread",
               "Infant mortality rate is the same across levels of human development")
tbl2_alt <- c("The sample median differs from its mean",
              "Social progress and human development are correlated",
              "There is a relationship between log(GDP) and infant mortality",
              "Happiness is not normally distributed",
              "Gender equality index and adjusted social progress index differ in spread",
...
tbl2_para <- c("One-Sample t-Test",
               ...
               "Levene's Test",
               "ANOVA")
tbl2 <- as.tibble(cbind(tbl2_test, tbl2_null, tbl2_alt, tbl2_nonpara, tbl2_para))
colnames(tbl2) <- c("Test", "Null Hypothesis", "Alternative Hypothesis", "Nonparametric Test", "Parametric Test")
tbl2_kbl <- tbl2 %>% 
  kable(format = "latex") %>% 
  column_spec(1, width = "3em", border_left = FALSE, border_right = FALSE) %>%
  column_spec(2, width = "10em", border_left = FALSE, border_right = FALSE) %>% 
  column_spec(3, width = "10em", border_left = FALSE, border_right = FALSE) %>% 
  column_spec(4, width = "10em", border_left = FALSE, border_right = FALSE) %>% 
  column_spec(5, width = "10em", border_left = FALSE, border_right = FALSE)
tbl2_kbl
```

All tests were performed at level $\alpha = 0.05$ in R.  The dataset, full code, and this report are available in an online repository (@kmpgit).
...
```{r HDIsumm, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r SPIplot, echo = FALSE, warning = FALSE, message = FALSE, fig.width = 4, fig.height = 2.5}
...
```{r SPIsumm, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r GDPplot, echo = FALSE, warning = FALSE, message = FALSE, fig.width = 4, fig.height = 2.5}
...
```{r logGDPsumm, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r happinessplot, echo = FALSE, warning = FALSE, message = FALSE, fig.width = 4, fig.height = 2.5}
...
```{r happinesssumm, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r genderplot, echo = FALSE, warning = FALSE, message = FALSE, fig.width = 4, fig.height = 2.5}
...
```{r gendersumm, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r infantmortplot, echo = FALSE, warning = FALSE, message = FALSE, fig.width = 4, fig.height = 2.5}
...
```{r infantmortsumm, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r lifeexp_summ, echo = FALSE, warning = FALSE, message = FALSE}
