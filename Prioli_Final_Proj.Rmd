...
analysis5_plot <- ggplot(data = alldata, aes(x = HDI_cat, y = log(infantmort))) +
  ...
  ggtitle("Figure 10.  Log Infant Mortality Rate by HDI Category")
analysis5_plot
```
